...
readonly REPO_URL="https://github.com/erffy-dots/uwsm.git"
...
echo "Downloading UWSM configuration files from GitHub..."

# Handle existing configuration
if [ -d "$CONFIG_DIR" ]; then
    echo "Existing UWSM configuration detected at '$CONFIG_DIR'."
...
# Final message
echo
echo "UWSM setup complete."
echo "Please review the files in '$CONFIG_DIR'."
echo "You may need to install additional dependencies for UWSM."
echo "Refer to the UWSM documentation for more information."
